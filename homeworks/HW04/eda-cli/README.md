...
### 5. `POST /summary-from-csv` – JSON-сводка по CSV-файлу (HW03)

Эндпоинт принимает CSV-файл и возвращает **полную JSON-сводку по датасету**, аналогичную CLI-режиму с опцией `--json-summary` из HW03.
